...
## 产出文档
- **需求评审报告**: `.opencode/docs/requirement-review-{feature}.md`
...
| 条件 | 推荐技能 |
|------|----------|
| 评审通过 | `collaboration/handoff/collab-product-to-dev` |
| 需重新评审 | `product/requirement/product-requirement-analysis` |
