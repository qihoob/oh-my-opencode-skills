...
将以下内容添加到你的 `~/.claude/CLAUDE.md`：

```markdown
# 全局技能系统

你的技能库位于 `/home/hugh/skill/`，在任何项目中都可以使用。
...
| 用户说 | 读取 |
|--------|------|
| 需求分析 | `/home/hugh/skill/product/requirement/product-requirement-analysis/SKILL.md` |
| 先看看代码 | `/home/hugh/skill/dev/context/dev-context-first/SKILL.md` |
| 实现功能 | `/home/hugh/skill/dev/implementation/dev-implementation/SKILL.md` |
| 代码审查 | `/home/hugh/skill/dev/code-review/SKILL.md` |
| 测试用例 | `/home/hugh/skill/qa/test-case/test-case-design/SKILL.md` |
| 执行测试 | `/home/hugh/skill/qa/execution/test-executor/SKILL.md` |
| 提测 | `/home/hugh/skill/collaboration/handoff/collab-dev-to-qa/SKILL.md` |
| 调试 | `/home/hugh/skill/dev/debugging/SKILL.md` |
| 重构 | `/home/hugh/skill/dev/refactoring/SKILL.md` |
| 项目分析 | `/home/hugh/skill/product/analysis/global-project-analysis/SKILL.md` |
```
