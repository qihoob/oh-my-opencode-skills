...
```bash
# 1. Clone 到任意目录
git clone https://github.com/qihoob/oh-my-opencode-skills.git ~/skill
...
sed -i "s|{{SKILL_DIR}}|$SKILL_DIR|g" ~/skill/CLAUDE.md ~/skill/AGENTS.md
...
你的技能库位于「SKILL_DIR_PLACEHOLDER」，在任何项目中都可以使用。
...
| 用户说 | 读取 |
|--------|------|
| 需求分析、用户故事 | SKILL_DIR_PLACEHOLDER/product/requirement/product-requirement-analysis/SKILL.md |
| 给我上下文、先看看代码 | SKILL_DIR_PLACEHOLDER/dev/context/dev-context-first/SKILL.md |
| 实现功能、写代码 | SKILL_DIR_PLACEHOLDER/dev/implementation/dev-implementation/SKILL.md |
| 代码审查、CR | SKILL_DIR_PLACEHOLDER/dev/code-review/SKILL.md |
| 测试用例 | SKILL_DIR_PLACEHOLDER/qa/test-case/test-case-design/SKILL.md |
| 执行测试 | SKILL_DIR_PLACEHOLDER/qa/execution/test-executor/SKILL.md |
| 半路测试、没有需求文档 | SKILL_DIR_PLACEHOLDER/qa/context/qa-context-from-code/SKILL.md |
| 提测 | SKILL_DIR_PLACEHOLDER/collaboration/handoff/collab-dev-to-qa/SKILL.md |
| 验收 | SKILL_DIR_PLACEHOLDER/collaboration/review/collab-acceptance-review/SKILL.md |
| Bug协调 | SKILL_DIR_PLACEHOLDER/collaboration/process/bug-coordinator/SKILL.md |
| 复盘 | SKILL_DIR_PLACEHOLDER/collaboration/process/collab-retrospective/SKILL.md |
| 线上故障、P0 | SKILL_DIR_PLACEHOLDER/collaboration/sync/incident/SKILL.md |
| 项目分析 | SKILL_DIR_PLACEHOLDER/product/analysis/global-project-analysis/SKILL.md |
| 调试、debug | SKILL_DIR_PLACEHOLDER/dev/debugging/SKILL.md |
| 重构、refactor | SKILL_DIR_PLACEHOLDER/dev/refactoring/SKILL.md |
| ADR、架构决策 | SKILL_DIR_PLACEHOLDER/dev/adr/SKILL.md |
| 评估依赖 | SKILL_DIR_PLACEHOLDER/dev/dependency-eval/SKILL.md |
| 保存上下文、恢复上下文 | SKILL_DIR_PLACEHOLDER/dev/context-restore/SKILL.md |

## 完整触发词映射

详见 SKILL_DIR_PLACEHOLDER/AGENTS.md

## 自驱动流程

详见 SKILL_DIR_PLACEHOLDER/system/chain-executor/SKILL.md

核心规则：文档产出 = 下一步自动触发。无需人工推流程。
HEREDOC

# 4. 替换全局配置中的占位符为实际绝对路径
sed -i "s|SKILL_DIR_PLACEHOLDER|$SKILL_DIR|g" ~/.claude/CLAUDE.md
```

> 步骤 3-4 会在 `~/.claude/CLAUDE.md` 中写入绝对路径，Claude Code 的 Read 工具需要绝对路径才能定位文件。
