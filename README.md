...
sed -i "s|{{SKILL_DIR}}|$SKILL_DIR|g" CLAUDE.md AGENTS.md
```

> 项目中使用 `{{SKILL_DIR}}` 占位符标记所有技能路径，安装时一次性替换。

### 2. 注册到 Claude Code

将以下内容添加到你的 `~/.claude/CLAUDE.md`（路径改为你的实际路径）：

```markdown
# 全局技能系统

你的技能库位于 `/home/yourname/skill/`，在任何项目中都可以使用。

## 技能加载方式：Read 文件，不要调用 Skill 工具
技能存储为 SKILL.md 文件，不是 Claude Code 原生注册的 skill。
...
| 用户说 | 读取 |
|--------|------|
| 需求分析 | `/home/yourname/skill/product/requirement/product-requirement-analysis/SKILL.md` |
| 先看看代码 | `/home/yourname/skill/dev/context/dev-context-first/SKILL.md` |
| 实现功能 | `/home/yourname/skill/dev/implementation/dev-implementation/SKILL.md` |
| 代码审查 | `/home/yourname/skill/dev/code-review/SKILL.md` |
| 测试用例 | `/home/yourname/skill/qa/test-case/test-case-design/SKILL.md` |
| 执行测试 | `/home/yourname/skill/qa/execution/test-executor/SKILL.md` |
| 提测 | `/home/yourname/skill/collaboration/handoff/collab-dev-to-qa/SKILL.md` |
| 调试 | `/home/yourname/skill/dev/debugging/SKILL.md` |
| 重构 | `/home/yourname/skill/dev/refactoring/SKILL.md` |
| 项目分析 | `/home/yourname/skill/product/analysis/global-project-analysis/SKILL.md` |
```

> 快速入口的完整列表见项目内的 `AGENTS.md`。
