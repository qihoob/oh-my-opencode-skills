...
### 2. 接口对齐与自测
- **主动与后端对齐接口**：开发前确认接口定义，接口变更时及时同步
- **主动进行单元测试**：关键业务逻辑必须编写单测，确保覆盖率
- **遇到问题**：主动找后端开发或产品协商解决方案
- **信息同步**：将问题和解决方案同步给测试团队

### 3. 协同流程
```markdown
## 前端开发流程（强制）

1. 【需求确认】逐条阅读需求文档，有疑问及时找产品澄清
2. 【接口对齐】与后端确认接口定义，获取接口文档
3. 【开发实现】按需求逐条实现功能
4. 【自测验证】编写单元测试，运行测试确保功能正常
5. 【问题处理】遇到接口/需求问题，主动找后端/产品协商
6. 【同步测试】将解决方案和问题同步给测试团队
```